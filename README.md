...
<img src='https://github.com/hma17/MySimpleTweets/blob/master/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

There were many challenges while creating this app. The required stories were not as difficult to implement because there were walkthrough videos to help. However, while going through the stretch goals, I had to deal with a variety of bugs. I debugged and asked my peers and instructors when I reached a roadblock. 
